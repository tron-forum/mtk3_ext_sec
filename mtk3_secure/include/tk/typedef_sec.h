...
/*
 *	typedef_sec.h  **Secure**
 *	Secure Extension T-Kernel Standard Data Type Definition
 */

#ifndef	_EXTSEC_TK_TYPEDEF_H_
#define _EXTSEC_TK_TYPEDEF_H_
