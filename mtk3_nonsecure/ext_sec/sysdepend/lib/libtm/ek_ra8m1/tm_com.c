...
#if (TRUSTZONE_NONSECURE)	// Non-Secure
	#define SCI3_BASE	(0x50358300)
#else				// Secure or TrustZone Disebled
...
#if (TRUSTZONE_NONSECURE)	// Non-Secure
	#define MSTPCRB		(0x50203004)
#else				// Secure or TrustZone Disebled
	#define MSTPCRB		(0x40203004)
#endif
